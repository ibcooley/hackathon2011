...
(function(){
    ...
    var updateCourse = function(arg) {
        ...
        if (dataBundle.eventsNow.length != 0)
            showNotifcation({
                "msg": dataBundle.eventsNow[0].message,
                "icon": dataBundle.eventsNow[0].icon
            });
    ...
    var showNotifcation = function(arg) {

        $("#events")
            .removeClass("sev1 sev2 sev3 sev4 sev5")
            .addClass(arg.icon)
            .empty()
            .append(
                $("<p />")
    ...
    onPageLoad = function() {
        ...
        $("#button-report-police")
            .live("click",function() {
                navigator.notification.confirm(
                    "Speeding is illegal. Information for entertainment purposes only.",
                    function() {},
                    "Continue?",
                    "Yes,No"
                );
