...
public class FishingSpotsListActivity extends ListActivity {
	...
	private void fillData() {
		...
		Cursor cursor = mDbHelper.fetchAllFishingSpots();
        startManagingCursor(cursor);

        
        // Create an array to specify the fields we want to display in the list (only TITLE)
        String[] from = new String[]{AnglerDbAdapter.SPOT_NAME};
